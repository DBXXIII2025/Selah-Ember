...
Future live giving should use Stripe Connect so eligible community organizers receive funds directly through their own connected Stripe accounts. Donations should never be routed through a personal account.
