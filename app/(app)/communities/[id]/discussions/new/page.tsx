...
import { createCommunityThread, getCommunityThreads } from "@/app/actions/discussions";

type NewCommunityDiscussionPageProps = {
...
export default async function NewCommunityDiscussionPage({ params, searchParams }: NewCommunityDiscussionPageProps) {
