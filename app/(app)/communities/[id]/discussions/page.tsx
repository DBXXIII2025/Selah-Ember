...
export default async function CommunityDiscussionsPage({ params, searchParams }: CommunityDiscussionsPageProps) {
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {!data.isSignedIn ? (
          ...
          <div className="mt-8 rounded-2xl border border-dashed border-[#d9b99d] bg-white/60 p-8 text-center">
            ...
            <p className="mt-3 text-[#67564c]">Start the first community conversation.</p>
          </div>
        ) : (
